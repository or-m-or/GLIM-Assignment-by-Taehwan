...
public:
    ...
    void DrawLabelsOnCanvas(Canvas& canvas, int offsetX, int offsetY);    // Canvas에 직접 텍스트 표시

private:
    std::vector<CStatic*> m_staticTexts; // 각 점에 대응하는 Static Text 컨트롤
    std::vector<CPoint> m_points;        // 각 점의 좌표 저장
};
